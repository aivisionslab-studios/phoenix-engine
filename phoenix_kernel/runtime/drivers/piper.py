...
class PiperDriver:
    ...
    @property
    def name(self) -> str: return "piper"
    ...
    async def execute(self, plan: ExecutionPlan) -> ExecutionResult:
        return ExecutionResult(plan_id=plan.id, status=ExecutionStatus.FAILED, errors=["piper driver not fully implemented in this build"])
