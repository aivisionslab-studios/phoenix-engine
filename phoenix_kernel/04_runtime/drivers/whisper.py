...
class WhisperDriver:
    ...
    @property
    def name(self) -> str: return "whisper"
    ...
    async def execute(self, plan: ExecutionPlan) -> ExecutionResult:
        return ExecutionResult(plan_id=plan.id, status=ExecutionStatus.FAILED, errors=["whisper driver not fully implemented in this build"])
