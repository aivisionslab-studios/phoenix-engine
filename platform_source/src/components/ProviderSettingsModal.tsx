  ...
  const getProviderIcon = (type: ProviderType) => {
    switch (type) {
      ...
      case 'stable-diffusion-cpp':
        return <Image className="w-5 h-5 text-fuchsia-400" />;
      case 'vllm':
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">
                Gerencie conexões locais (llama.cpp, stable-diffusion.cpp, Ollama, LM Studio) e APIs de nuvem (Gemini, OpenAI, Custom)
              </p>
            </div>
          </div>
          <button
