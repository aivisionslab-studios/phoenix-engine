...
interface ArenaViewProps {
  ...
  onExecuteArena: (slots: ArenaSlot[], prompt: string) => Promise<void>;
  isLoading: boolean;
}
...
export const ArenaView: React.FC<ArenaViewProps> = ({
  ...
  const handleRunArena = async () => {
    ...
    setWinnerId(null);
    await onExecuteArena(slots, promptText);
  };
  ...
  return (
    <div id="arena-view-container" className="flex-1 flex flex-col bg-slate-950 text-slate-100 overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto p-4 sm:p-6">
        <div className={`grid grid-cols-1 md:grid-cols-${slots.length} gap-4 h-full min-h-[400px]`}>
